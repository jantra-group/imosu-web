...
export function CallToAction() {
      return (
            <div className="w-full pt-4 md:pt-8">
                  <div className="rounded-xl md:rounded-3xl bg-gradient-to-br from-[#D70A0A] to-[#9C0808] px-8 py-16 flex flex-row relative z-10 h-[600px] lg:h-fit">
                        ...
                        <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 lg:left-auto lg:right-0 lg:top-[-35px] lg:translate-x-0">
