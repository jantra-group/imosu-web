      ...
      return (
            <div className="flex flex-col gap-3">
                  ...
                  <Link href="https://www.instagram.com/imosu.official/" className="flex gap-4 items-center">
                        <FaInstagram size={36} color="#CC0000" />
                        <p className="text-2xl text-primary-500 font-bold">imosu.official</p>
                  </Link>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
                        ...
                        <Link href="https://www.instagram.com/imosu.official/" className="bg-primary-500 flex items-center gap-3 py-2 text-lg font-semibold shadow-lg w-fit px-8 rounded-lg mx-auto mt-5 text-white" passHref>
