...
export function PopupCart() {
      ...
      // Menghitung subtotal & total
      const subtotal = products.reduce((acc, product) => acc + product.price * product.quantity, 0);
      const discount = 10000; // Misalnya diskon tetap
      const total = subtotal - discount;

      return (
            isOpen && (
                  <div
                        className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center px-20"
                        onClick={() => setIsOpen(false)}
                  >
                        <div
                              className="bg-white flex flex-col rounded-xl p-10 gap-8 w-full max-w-[1440px] h-full max-h-[450px] overflow-y-auto"
                                    ...
                                    <div className="flex flex-col gap-2">
                                          ...
                                          <div className="inline-flex bg-neutral-300 border border-black px-4 py-2 rounded-2xl">
                                                <input
                                                      ...
                                                      className="w-[235px] text-base bg-neutral-300 focus:outline-none"
                                                />
