...
export default function StabilizerBushProducts() {
      const breadcrumbItems = [
            { label: 'Dashboard', href: '' },
            { label: 'Produk', href: '/dashboard/products' },
            { label: 'Stabilizer Bush', href: '/dashboard/products/stabilizer-bush' }
      ]
            ...
            <main className="p-5 flex flex-col gap-3 w-full max-w-[1440px]">
                  <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-3">
                              <h1 className="text-[32px] font-bold text-black">Stabilizer Bush</h1>
